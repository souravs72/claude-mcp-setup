...
def setup_logging(
    ...
    # Console handler - ONLY stderr, ONLY errors/critical
    console_handler = logging.StreamHandler(sys.stderr)
    console_handler.setLevel(logging.ERROR)  # Changed from WARNING
...
def log_server_startup(logger: logging.Logger, server_name: str, config: dict):
